...
def generateBotEn(outputPath, inputPath):
    ...
    model_bh = outputPath+'/03.weights.05-0.11579_0.9733_fasttext_02.hdf5'
...
generateBotEn('/Volumes/MacPassport/PycharmProjects/botOrNot','/Users/kram/Downloads/botOrNot-en_es')
